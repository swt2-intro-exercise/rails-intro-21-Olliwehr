...
describe "Edit author page", type: :feature do
  ...
  it "should update author's data on submit" do
    ...
    expect(updated_author.first_name).to be eq new_first_name
    expect(updated_author.last_name).to be eq new_last_name
    expect(updated_author.homepage).to be eq new_homepage
  end
